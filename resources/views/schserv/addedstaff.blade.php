      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <h1> @foreach($deppt as $data)
                <b> <h4> See Members of the department of "{{$data->deptnam}}" </h4><b>
            </h1>
               </div>
               <button class="btn btn-warning btn-sm"> <a href="{{url('/devdept/'.$data->id)}}">Back </a></button> 
               @endforeach
            </div>
            </section>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    <tr>
                                    @forelse($addedstaff as $datda)
                                       <td>{{$counter+=1}}</td>
                                       <td>{{$datda->fullnam}}</td> 
                                       <td style="display: none;">{{$datda->id}}</td>
                                        <td> <form method="GET" action='/staffdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
