                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add New Bursary Unit</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/buradd'>
                           @csrf	
                            <div class="form-group ">
                              <label>Bursary unit  Name </label>
                              <input type="text"  class="form-control" name="burn" >
                            </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th>Edit</th>
                                       <th>Delete</th>
                                       <th>Add Bursary Unit details</th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($bur as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/burdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/burdet/'.$data->id)}}">Add Bursary unit details</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit Bursary name</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editbur/{id}'>
                                  @csrf	
                              ...
                              <input type="text"  class="form-control" name="burn3"  id="burn2" >
                            </div>
                             
                         
                            <input type= "submit" value="Update Bursary unit"> <br>  <br>
                           </form>
