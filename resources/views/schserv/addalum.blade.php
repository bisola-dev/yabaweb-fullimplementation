         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add alumni Type</h1>
                  <small>Add alumni Type.</small>
               </div>
            </section>
         	<!-- Page Wrapper -->
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add Alumni news </h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/createalum'>
                           @csrf	
                            <div class="form-group ">
                              <label> Alumni News Title </label>
                              <input type="text"  class="form-control" name="alumn" >
                            </div>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                    <th>Id</th>
                                       <th> Alumni News Title </th>
                                       <th>Edit</th>
                                       <th>Delete</th>
                                       <th>Develop alumni details</th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($alum as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deletealum/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/alumdet/'.$data->id)}}">Develop alumni news</a>
                                        </div>
</td>
                                                </div>
                                            </td>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatealum/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Alumni News Title </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="alumn3" id="alumn2" >
                            </div>
                             <div>
