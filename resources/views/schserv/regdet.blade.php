...
<head>
      ...
      <title>Add Registry  details s </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($reg  as $data)
                    <b> <h4> welcome  to "{{$data->regn}}"</h4><b>
             @endforeach</h1>
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($reg as $data)   
                                 <h4> ADD further details  to "{{$data->regn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/reg')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/regdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="regn" value="{{$data->regn}}">
                                  
                            </div>
                            <label>Registry Acronym </label>
                            <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="regacr" value="{{$data->regacr}}">
                            </div>
                         
                            <div class="form-group ">
                              <label>Registry Head title</label>
                              <input type="text"  class="form-control" name="regh" value="{{$data->regh}}">
                          
                            </div>

                            <div class="form-group ">
                              <label>Registry head fullname</label>
                              <input type="text"  class="form-control" name="regfn" value="{{$data->regfn}}" >
                          
                            </div>
                               
                            @endforeach
                            
                              <input type= "submit" value="Submit  Registry Unit"> <br>  <br>
                           </form>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       <th>upload logo</th>
                                       <th>Develop Registry details </th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($reg as $datda)
                                             ...
                                             <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> Upload Unit logo </a><br>
                                                        <a class="dropdown-item lumi" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> Upload Director image </a>
                                       ...
                                       <a href="{{url('/regprofile/'.$datda->id)}}">View & Create Registry profile </a>
                                        </div>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit Registry details</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/regupdate/{id}'>
                                  @csrf	
                              <div class="form-group "> 
                                  @foreach($reg  as $data)  
                              <label>Registry  Name </label>
                              <input type="text"  class="form-control" name="regn3" value="{{$data->regn}}">
                            ...
                            @endforeach
                              ...
                              <input type="text"  class="form-control" id="regacr2" name="regacr3" >
                            </div>
                        
                            <div class="form-group ">
                              <label>Registry Head title</label>
                              <input type="text"  class="form-control" name="regh3" id="regh2" >
                          
                            </div>

                            <div class="form-group ">
                              <label>Registry head fullname</label>
                              <input type="text"  class="form-control" name="regfn3" id="regfn2"  >
                            </div>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($reg as $data)  
							<td><img src="/storage/reglogo/{{($data->reglogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
                           <h5 class="modal-title">Upload Unit Logo</h5>
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/reglogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
                      ...
                      <input type="file" class="form-control" name="reglogo">
                     </div>
                     </div>
      ...
      <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img">
                        <td><img src="/storage/regdirlogo/{{($data->regdirlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
  ...
  <form method="post" action='/regdirlogo/{id}'  enctype="multipart/form-data">
          @csrf	
 <div class="col-sm-6 col-md-12">
<div class="form-group"> 
 ...
 <input type="hidden" name="id" id ="id4">
  <input type="file" class="form-control" name="regdirlogo">
  </div>
  </div>
