                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add New Schools</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/createskol'>
                           @csrf	
                            <div class="form-group ">
                              <label>School Name </label>
                              <input type="text"  class="form-control" name="skolssn" >
                            </div>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($skooldeet  as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deleteskol/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/skoladd/'.$data->id)}}">Add school details</a>
                                        </div>
                                        <td>
                                        <div class="btn btn-warning btn-sm">
                                       <a href="{{url('/adddept/'.$data->id)}}">View Department</a>
                                        </div>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit  Schoolname</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editskol/{id}'>
                                  @csrf	
                                  <div class="form-group ">   
                              <label>School Name </label>
                              <input type="text"  class="form-control" name="skols3" id ="skolssn2" >
                              <input type="hidden" name="id" class="form-control"  id="id2">
                            </div>

                            <input type= "submit" value="Update Schoolname"> <br>  <br>
                           </form>
