         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Knowledge Unit</h1>
                  <small>Knowledge  Unit</small>
               </div>
            </section>
         	<!-- Page Wrapper -->
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/knowadd'>
                           @csrf	
                            <div class="form-group ">
                              <label>Add Articles Question </label>
                              <input type="text"  class="form-control" name="known" >
                            </div>
                            
                              <input type= "submit" value="Submit Knowledge "> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($know as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/knowdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/knowdet/'.$data->id)}}">Develop Articles</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit Article title</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editknow/{id}'>
                                  @csrf	
                              ...
                              <input type="text"  class="form-control" name="known3"  id="known2">
                            </div>
                             
                         
                            <input type= "submit" value="Update Knowledge unit"> <br>  <br>
                           </form>
