                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($event as $data)   
                                 <h4> ADD further details  to "{{$data->eventn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/addevent')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/eventdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="eventn" value="{{$data->eventn}}">
                            ...
                            <div class="form-group ">
                              <label> Event date</label> *mm-dd-yyyy*
                              <input type="date"  class="form-control" name="eventdt" value="{{$data->eventdt}}">
                            </div>
                            
                            <div class="form-group ">
                              <label> Event Venue</label>
                              <input type="text"  class="form-control" name="eventv" value="{{$data->eventv}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <textarea class="form-control" id="body" name="eventabt" >{!! $data->eventabt !!}</textarea>
                            </div>
                            @endforeach
                           ...
                           <form method="post" action='/eventlogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
						<div class="profile-img">
                        @foreach($event as $data) 
                        @if($data->eventlogo)
                <img src="/storage/eventlogo/{{$data->eventlogo}}" width="100px", height="100px">   
                    @endif   
                            <div class="panel-body">
                            <div class="form-group"> 
                       <label>Upload Event's Image (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" value ="{{$data->id}}">
                       @endforeach
                      <input type="file" class="form-control" name="eventlogo">
