...
<head>
      ...
      <title>add Service details s </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($serv   as $data)
                    <b> <h4> welcome  to "{{$data->servn}}"</h4><b>
             @endforeach</h1>
               ...
               <div class="row">
                  <div class="col-sm-12">
                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($serv as $data)   
                                 <h4> ADD further details  to "{{$data->servn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/serv')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/servfuadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="servn" value="{{$data->servn}}">
                                  
                            </div>
                            <label>Service Acronym </label>
                            <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="servacr" value="{{$data->servacr}}">
                            </div>
                            
                            <div class="form-group ">
                              <label>Service Head title</label>
                              <input type="text"  class="form-control" name="servh" value="{{$data->servh}}" >
                          
                            </div>

                            <div class="form-group ">
                              <label>Service head fullname</label>
                              <input type="text"  class="form-control" name="servfn" value="{{$data->servfn}}">
                          
                            </div>
                            
                            @endforeach
                              <input type= "submit" value="Submit Service"> <br>  <br>
                           </form>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($serv as $datda)
                                             ...
                                             <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-2"></i> Upload service logo </a><br>
                                                        <a class="dropdown-item lumi" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-2"></i> Upload director logo </a>
                                       ...
                                       <a href="{{url('/servprofile/'.$datda->id)}}">View & Create Service history  </a>
                                        </div>
                                          </div>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($serv as $data)  
							<td><img src="/storage/servlogo/{{($data->servlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
                           <h5 class="modal-title">Upload service Logo</h5>
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/upserv/{id}'  enctype="multipart/form-data">
                                  @csrf	

                                  <div class="col-sm-6 col-md-12">
                                 <div class="form-group"> 
              
                       <label>Select school's logo (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" id ="id3">
                      <input type="file" class="form-control" name="servlogo">
                     </div>
                     </div>
      ...
      <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img">
                        <td><img src="/storage/dirlogo/{{($data->dirlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
                        <h5 class="modal-title">Upload Diretor's Logo</h5>
  ...
  <form method="post" action='/dirlogo/{id}'  enctype="multipart/form-data">
          @csrf	
 <div class="col-sm-6 col-md-12">
<div class="form-group"> 
 ...
 <input type="hidden" name="id" id ="id4">
  <input type="file" class="form-control" name="dirlogo">
  </div>
  </div>
