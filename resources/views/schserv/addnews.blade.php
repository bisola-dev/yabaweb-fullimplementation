                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           @csrf	
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="newsn" >
                            </div>
                        
                            
                              <input type= "submit" value="Save News "> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($news as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deletenews/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/newsdet/'.$data->id)}}">Develop News</a>
                                        </div>
</td>
                                                </div>
                                            </td>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatenews/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Name </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="newsn3" id="newsn2" >
                            </div>
                             <div>
                            <input type= "submit" value="Update  News"> <br>  <br>
                            </div>
                           </form>
