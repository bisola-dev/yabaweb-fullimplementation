         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($know  as $data)
                    <b> <h4> welcome  to "{{$data->known}}"</h4><b>
             @endforeach</h1>
                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($know as $data)   
                                 <h4> ADD further details  to "{{$data->known}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/know')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/knowdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="known" value="{{$data->known}}">
                            ...
                            <div class="form-group ">
                              ...
                              <textarea class="form-control" id="body" name="knowabt" >{!!$data->knowabt!!}</textarea>
                            </div>

                            <div class="form-group ">
                           <label>Category of articles</label>  *you selected {{!!$data->knowcat!!}}*     @endforeach

                           <select class="form-control"  name="knowcat"> 
                         <option value="">-- Select category --</option>
                         @foreach($cate as $cat)
                        <option value="{{$cat->caten}}">{{$cat->caten}}</option>
                        @endforeach
                          </select>
                           </div>
                         ...
                         <form method="post" action='/knowlogo/{id}'  enctype="multipart/form-data">
                           @csrf	
                         <div class="profile-img">
                        @foreach($know as $data)  
                        @if($data->knowlogo)
							 <td><img src="/storage/knowlogo/{{($data->knowlogo)}}" width="100px", height="100px"></td> 
                       @endif   
                           <h5>Upload Knowledge image  (COMPULSORY SIZE 770 x 440 Pixels)</h5>
                            <div class="panel-body">
                            <div class="form-group"> 

                       <label>Select knowledge image (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" value ="{{$data->id}}">
                       @endforeach

                      <input type="file" class="form-control" name="knowlogo">
