                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/acadadd'>
                           @csrf	
                            <div class="form-group ">
                              <label>Academic unit  Name </label>
                              <input type="text"  class="form-control" name="acadn" >
                            </div>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($acad as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/acaddel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/acaddet/'.$data->id)}}">Add Academic unit details</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit  Academic name</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editacad/{id}'>
                                  @csrf	
                              ...
                              <input type="text"  class="form-control" name="acadn3"  id="acadn2" >
                            </div>
                             
                         
                            <input type= "submit" value="Update unit"> <br>  <br>
                           </form>
