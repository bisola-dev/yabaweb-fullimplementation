                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($lib as $data)
                                 <h4> ADD further details  to "{{$data->libn}}"</h4>
                                 @endforeach
                              </a>
                           </div>
                           <button> <a href="{{url('/libdet/'.$data->id)}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                        <form method="post"  action='/libprofprocess/{id}' enctype="multipart/form-data">
                           @csrf	 
                        @foreach($lib as $datda)    
                            <div class="form-group ">
                              <label>Library  Name</label>
                              <input type="text"  class="form-control" name="libn" value="{{$datda->libn}}" > 
                            </div> 
                            ...
                            <input type="text" class="form-control"  name ="libacr" value="{{$datda->libacr}}">
                            </div>
                        
               

                            <div class="form-group ">
                            <label>Library  Unit tittle</label>
                            <input type="text" class="form-control" name="libh"  value="{{$datda->libh}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control"  name="libfn" value="{{$datda->libfn}}">
                            </div>
                        


                            <div class="form-group ">
                              <label>About Library  Unit </label>
                              <textarea class="form-control" id="body" name="abtlib" >{!!$datda->abtlib!!}</textarea>
                            </div>
                       ...
                       <form method="post"  action='/libstaff'>
                          @csrf	 
                       @foreach($lib as $datda)  
                       <div class="form-group ">  
                          
                             <input type="hidden"  class="form-control" name="libid" value="{{$datda->id}}" >
                           @endforeach
                           </div>
                        ...
                        @endforeach
                           ...
                           <input type= "submit" value="Update Staff"> <br>  <br>
                                          ...
                                          @foreach($lib as $datda)
                                       @endforeach
                                  <a href= "{{url('/viewlibstaff/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View  Unit staff</a>
                                    </td>
