                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           @csrf	
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="eventn" >
                            </div>
                        
                            
                              <input type= "submit" value="Save event "> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($event as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deleteevent/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/eventdet/'.$data->id)}}">Develop event</a>
                                        </div>
</td>
                                                </div>
                                            </td>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updateevent/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Event Title </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="eventn3" id="eventn2" >
                            </div>
                             <div>
