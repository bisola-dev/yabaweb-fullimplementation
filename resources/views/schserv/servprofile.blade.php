                     ...
                     <div class="panel panel-bd lobidrag">
                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($serv as $data)
                                 <h4> ADD further details  to "{{$data->servn}}"</h4>
                                 @endforeach
                              </a>
                           </div>
                           @foreach($serv as $datra)
                           <button> <a href="{{url('/servadd/'.$datra->id)}}">Back </a></button>
                        </div>
                        @endforeach
                        <div class="panel-body">
                       
                        <form method="post"  action='/servprofadd/{id}' enctype="multipart/form-data">
                           @csrf	 
                        ...
                        @foreach($serv as $data)  
                             <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" value="{{$data->servacr}}"  name="servacr">
                            </div>
                        
                            <div class="form-group ">
                              <label>Service Head title</label>
                              <input type="text"  class="form-control" value="{{$data->servh}}" name="servh" >
                          
                            </div>

                            <div class="form-group ">
                              <label>Service head fullname</label>
                              <input type="text"  class="form-control"  value="{{$data->servfn}}"  name="servfn"  >
                            </div>
                            ...
                            <div class="form-group ">
                              <label>About unit</label>
                              <textarea class="form-control" id="body" name="abtunit" >{!! $data->abtunit !!}</textarea>
                            </div>



                            <div class="form-group ">
                              <label>unit's head  Profile</label>
                              <textarea class="form-control" id="body3" name="headprof" >{!! $data->headprof !!}</textarea>
                            </div>
                            @endforeach
                       ...
                       <form method="post"  action='/servaddstaff'>
                          @csrf	 
                       @foreach($serv as $datda)  
                       <div class="form-group ">  
                             <input type="hidden"  class="form-control" name="servid" value="{{$datda->id}}"> 
                           @endforeach
                           </div>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                  ...
                                  <a href= "{{url('/viewstaff/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View staff</a>
                                    </td>
                                           </div>
                                           </tr>
                                           <div>
