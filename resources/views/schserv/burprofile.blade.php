                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($bur as $data)
                                 <h4> ADD further details  to "{{$data->burn}}"</h4>
                                 @endforeach
                              </a>
                           </div>
                           <button> <a href="{{url('/burdet/'.$data->id)}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                        <form method="post"  action='/burprofprocess/{id}' enctype="multipart/form-data">
                           @csrf	 
                        @foreach($bur as $datda)    
                            <div class="form-group ">
                              <label>Bursary  Name</label>
                              <input type="text"  class="form-control"  name="burn" value="{{$datda->burn}}" > 
                            </div> 
                            ...
                            <input type="text" class="form-control"  name="buracr" value="{{$datda->buracr}}">
                            </div>
                        
               

                            <div class="form-group ">
                            <label>Bursary  Unit tittle</label>
                            <input type="text" class="form-control"  name="burh" value="{{$datda->burh}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="burfn" value="{{$datda->burfn}}">
                            </div>
                       

                            <div class="form-group ">
                              <label>About Bursary  Unit </label>
                              <textarea class="form-control" id="body" name="abtbur" >{!!$datda->abtbur!!}</textarea>
                            </div>
                            

                            <div class="form-group ">
                              <label>Director's  Profile</label>
                              <textarea class="form-control" id="body3"name="headprof" >{!!$datda->headprof!!}</textarea>
                            </div>
                            @endforeach
                       ...
                       <form method="post"  action='/burstaff'>
                          @csrf	 
                       @foreach($bur as $datda)  
                       <div class="form-group ">  
                          
                             <input type="hidden"  class="form-control" name="burid" value="{{$datda->id}}" >
                           @endforeach
                           </div>
                        ...
                        @endforeach
                           ...
                           <!-- ./Plugin content:powerpoint,txt,pdf,png,word,xl -->
                                       ...
                                       @foreach($bur as $datda)
                                       @endforeach
                                  <a href= "{{url('/viewburstaff/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View  Unit staff</a>
                                    </td>
