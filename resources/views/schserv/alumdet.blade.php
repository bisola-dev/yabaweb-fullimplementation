                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($alum as $data)   
                                 <h4> ADD further details  to "{{$data->alumn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/addalum')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/alumdetadd/{id}'>
                           @csrf	
                            <div class="form-group ">
                            @foreach($alum  as $data)

                            <div class="form-group ">
                              <label>Alumni News Title</label>
                              <input type="hidden"  class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="alumn" value="{{$data->alumn}}">
                            ...
                            <div class="form-group ">
                              <label>Details</label>
                              <textarea class="form-control" id="body" name="alumabt" >{!!$data->alumabt!!}</textarea>  @endforeach
                            </div>
                           ...
                           <form method="post" action='/alumlogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
						<div class="profile-img">
                        @foreach($alum as $data) 
                        @if($data->alumlogo)
                <img src="/storage/alumlogo/{{$data->alumlogo}}" width="100px", height="100px">   
                    @endif   
                            <div class="panel-body">
                            <div class="form-group"> 
                       <label>Upload Alumni Event's Image (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" value ="{{$data->id}}">
                       @endforeach
                      <input type="file" class="form-control" name="alumlogo">
