                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              ...
                              @foreach($skooldeet as $data)
                                 <h4>Add New Departments to {{$data->skolssn}}</h4>
                                 @endforeach
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                           ...
                           <form method="post" action='/adddeptdpro'>
                           @csrf	
                            <div class="form-group ">
                              <label>Department Name </label>
                              @foreach($skooldeet as $data)
                              <input type="text"  class="form-control" name="deptnam" >
                              <input type="hidden"  class="form-control" value="{{$data->id}}" name="skolid">
                            </div>
                            @endforeach
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($deppt as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/adddeptdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/devdept/'.$data->id)}}">Develop Department</a>
                                        </div>
                                        <td>
                                
                                        <div class="btn btn-warning btn-sm">
                                       <a href="{{url('/newprog/'.$data->id.'/'.$data->skolid)}}">Add new programme</a>
                                        </div>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/deptupdate/{id}'>
                                  @csrf	
                                  <div class="form-group ">   
                              <label>Department Name </label>
                              @foreach($skooldeet as $data)
                              <input type="hidden"  class="form-control" name="skolid3" value="{{$data->id}}" >@endforeach
                              <input type="text"  class="form-control" name="deptnam3" id ="deptnam2" >
