...
<head>
      ...
      <title>Add Library  details s </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($lib  as $data)
                    <b> <h4> welcome  to "{{$data->libn}}"</h4><b>
             @endforeach</h1>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($lib as $data)   
                                 <h4> ADD further details  to "{{$data->libn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/lib')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/libdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="libn" value="{{$data->libn}}">
                                  
                            </div>
                            <label>Library Acronym </label>
                            <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="libacr"value="{{$data->libacr}}">
                            </div>
                         
                            <div class="form-group ">
                              <label>Library Head title</label>
                              <input type="text"  class="form-control" name="libh" value="{{$data->libh}}">
                          
                            </div>

                            <div class="form-group ">
                              <label>Library head fullname</label>
                              <input type="text"  class="form-control" name="libfn" value="{{$data->libfn}}">
                          
                            </div>
                               
                            @endforeach
                            
                              <input type= "submit" value="Submit  Library Unit"> <br>  <br>
                           </form>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($lib as $datda)
                                       ...
                                       <a href="{{url('/libprofile/'.$datda->id)}}">View & Create Library  profile </a>
                                        </div>
                                          </div>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($lib as $data)  
							<td><img src="/storage/liblogo/{{($data->liblogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/liblogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
                      ...
                      <input type="file" class="form-control" name="liblogo">
                     </div>
                     </div>
      ...
      <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img">
                        <td><img src="/storage/libdirlogo/{{($data->libdirlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        @endforeach
  ...
  <form method="post" action='/libdirlogo/{id}'  enctype="multipart/form-data">
          @csrf	
 <div class="col-sm-6 col-md-12">
<div class="form-group"> 
 ...
 <input type="hidden" name="id"  value="{{$data->id}}">
  <input type="file" class="form-control" name="libdirlogo">
  </div>
  </div>
