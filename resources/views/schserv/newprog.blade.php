                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              ...
                              @foreach($deppt as $data)
                                 <h4>Add Programme to {{$data->deptnam}}</h4>
                                 @endforeach
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                           ...
                           <form method="post" action='/addprog'>
                           @csrf	
                            <div class="form-group ">
                              <label>Add programme </label>
                              @foreach($deppt as $data)
                              <input type="hidden"  class="form-control" value="{{$data->id}}" name="deptid">
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($newprog as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/addprogdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/addviewprog/'.$data->id.'/'.$data->skolid.'/'.$data->deptid)}}">View /add new programmes</a>
                                        </div>
                                          </div>
