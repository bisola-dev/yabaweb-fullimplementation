                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add New Service unit</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/serveadd'>
                           @csrf	
                            <div class="form-group ">
                              <label>Service unit  Name </label>
                              <input type="text"  class="form-control" name="servn" >
                            </div>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($serv as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/servadddel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/servadd/'.$data->id)}}">service unit details</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit  Servicename</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editserv/{id}'>
                                  @csrf	
                               
                                  <div class="form-group ">
                                 <input type="hidden"  class="form-control"  name="id" id ="id2" >
                              <label>Service unit  Name </label>
                              <input type="text"  class="form-control" name="servn3"  id="servn2" >
                            </div>
