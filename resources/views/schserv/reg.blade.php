                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           @csrf	
                            <div class="form-group ">
                              <label>Registry unit  Name </label>
                              <input type="text"  class="form-control" name="regn" >
                            </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th>Edit</th>
                                       <th>Delete</th>
                                       <th>Add Registry Unit details</th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($reg as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/regdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/regdet/'.$data->id)}}">Add registry unit details</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit Registry name</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editreg/{id}'>
                                  @csrf	
                               
                                  <div class="form-group ">
                                             
                              <label>Academic  unit  Name </label>
                              <input type="hidden"  class="form-control"  name="id" id ="id2" >   
                              <input type="text"  class="form-control" name="regn3"  id="regn2" >
                            </div>
                             
                         
                            <input type= "submit" value="Update  Registry unit"> <br>  <br>
                           </form>
