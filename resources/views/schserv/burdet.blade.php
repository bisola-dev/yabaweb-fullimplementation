...
<head>
      ...
      <title>Add Bursary  details s </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($bur  as $data)
                    <b> <h4> welcome  to "{{$data->burn}}"</h4><b>
             @endforeach</h1>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($bur as $data)   
                                 <h4> ADD further details  to "{{$data->burn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/bur')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/burdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="burn" value="{{$data->burn}}">
                                  
                            </div>
                            <label>Bursary Acronym </label>
                            <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="buracr" value="{{$data->buracr}}">
                            </div>
                            
                        
                            <div class="form-group ">
                              <label>Bursary Head title</label>
                              <input type="text"  class="form-control" name="burh" value="{{$data->burh}}" >
                          
                            </div>

                            <div class="form-group ">
                              <label>Bursary head fullname</label>
                              <input type="text"  class="form-control" name="burfn"  value="{{$data->burfn}}" >
                            </div>
                            @endforeach
                            
                              <input type= "submit" value="Submit  Bursary Unit"> <br>  <br>
                           </form>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    <tr>
                                    @forelse($bur as $datda)
                                                                      
                                             <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-upload"></i></a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> Upload Unit logo </a><br><br>
                                       ...
                                       <a href="{{url('/burprofile/'.$datda->id)}}">View & Create Bursary  profile </a>
                                        </div>
                                          </div>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($bur as $data)  
							<td><img src="/storage/burlogo/{{($data->burlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/burlogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
                      ...
                      <input type="file" class="form-control" name="burlogo">
                     </div>
                     </div>
      ...
      <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img">
                        <td><img src="/storage/burdirlogo/{{($data->burdirlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
  ...
  <form method="post" action='/burdirlogo/{id}'  enctype="multipart/form-data">
          @csrf	
 <div class="col-sm-6 col-md-12">
<div class="form-group"> 
 ...
 <input type="hidden" name="id" value="{{$data->id}}">   @endforeach
  <input type="file" class="form-control" name="burdirlogo">
  </div>
  </div>
