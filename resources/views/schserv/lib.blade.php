                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add New Library Unit</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/libadd'>
                           @csrf	
                            <div class="form-group ">
                              <label>Library unit  Name </label>
                              <input type="text"  class="form-control" name="libn" >
                            </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th>Edit</th>
                                       <th>Delete</th>
                                       <th>Add Library Unit details</th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($lib as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/libdel/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                        ...
                        <button type ="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to DELETE?');"><i class="fa fa-trash-o"></i></button>
                          ...
                          <td><div class="btn btn-warning btn-sm">
                                       <a href="{{url('/libdet/'.$data->id)}}">Add Library unit details</a>
                                        </div>
</td>
                                          </div>
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/editlib/{id}'>
                                  @csrf	
                              ...
                              <input type="text"  class="form-control" name="libn3"  id="libn2" >
                            </div>
                             
                         
                            <input type= "submit" value="Update Library unit"> <br>  <br>
                           </form>
