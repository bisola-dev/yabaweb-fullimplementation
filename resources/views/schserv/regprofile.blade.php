                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($reg as $data)
                                 <h4> ADD further details  to "{{$data->regn}}"</h4>
                                 @endforeach
                              </a>
                           </div>
                           <button> <a href="{{url('/regdet/'.$data->id)}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                        <form method="post"  action='/regprofprocess/{id}' enctype="multipart/form-data">
                           @csrf	 
                        @foreach($reg as $datda)    
                            <div class="form-group ">
                              <label>Registry  Name</label>
                              <input type="text"  class="form-control"  name="regn" value="{{$datda->regn}}" > 
                            </div> 
                            ...
                            <input type="text" class="form-control" name="regacr"  value="{{$datda->regacr}}">
                            </div>
                        
               

                            <div class="form-group ">
                            <label>Registry  Unit tittle</label>
                            <input type="text" class="form-control"   name="regh" value="{{$datda->regh}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="regfn" value="{{$datda->regfn}}">
                            </div>
            

                            <div class="form-group ">
                              <label>About Registry  Unit </label>
                              <textarea class="form-control" id="body" name="abtreg" >{!!$datda->abtreg!!}</textarea>
                            </div>
                       ...
                       <div class="form-group ">  
                             ...
                             <input type="hidden"  class="form-control" name="regid" value="{{$datda->id}}" >
                           @endforeach
                           </div>
                        ...
                        @endforeach
                           ...
                           <!-- ./Plugin content:powerpoint,txt,pdf,png,word,xl -->
                                  ...
                                  <a href= "{{url('/viewregstaff/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View  Unit staff</a>
                                    </td>
