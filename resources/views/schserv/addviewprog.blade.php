                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                              @foreach($newprog as $data)
                                 <h4>Add Programme to {{$data->prog}}</h4>
                                 @endforeach
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                           ...
                           <form method="post" action='/addprogstat'>
                           @csrf	
                            <div class="form-group ">
                              <label>Add Programme </label>
                              @foreach($newprog as $data)
                              <input type="hidden"  class="form-control" value="{{$data->id}}" name="progid">
                              <input type="hidden"   class="form-control" value="{{$data->skolid}}" name="skolid">
                              <input type="hidden"   class="form-control" value="{{$data->deptid}}" name="deptid">
                              <input type="text"  class="form-control" value="{{$data->prog}}" name="prog" >
                              @endforeach 
                            </div>
                            ...
                            <select class="form-control"  name="statnam"  >
                          <option value="">-- Select status of programme --</option>
                          @foreach($stat as $state)
                         <option value="{{$state->namkzx}}">{{$state->namkzx}}</option>
                         @endforeach
                           </select>
                            </div>

                        <input type= "submit" value="Submit programme"> <br>  <br>
                           </form>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    <tr>
                                    @forelse($progstat as $riu)
                                       <td>{{$counter+=1}}</td>
                                       <td>{{$riu->prog}}</td> 
                                       <td>{{$riu->statnam}}</td> 
                                       <td style="display: none;">{{$riu->progid}}</td>
                                       <td style="display: none;">{{$riu->id}}</td>
                                     <td> <form method="GET" action='/addviewprogdel'>  
                                        {{method_field('DELETE')}}
                                             @csrf
                                             <input type="hidden" name="progid" value="{{$riu->progid}}"> 
                     <input type="hidden" name="id" value="{{$riu->id}}"> 
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/progupdate/{id}'>
                                  @csrf	
                                  <div class="form-group ">   
                              <label>Programme </label>
                              @foreach($newprog as $data)
                              <input type="hidden"  class="form-control" name="skolid3" value="{{$data->id}}" >@endforeach
                              <input type="text"  class="form-control" name="prog3" id ="prog2" >
                              <input type="hidden" name="id" class="form-control"  id="id2">
                            </div>
                           
                            <input type= "submit" value="Update programme"> <br>  <br>
                           </form>
