                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($news as $data)   
                                 <h4> ADD further details  to "{{$data->newsn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/addnews')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/newsdetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="newsn" value="{{$data->newsn}}">
                                  
                            </div>
                          
                    
                            <div class="form-group ">
                              <label>About news </label>
                              <textarea class="form-control" id="body" name="newsabt" >{!!$data->newsabt!!}</textarea>
                            </div>

                            <div class="form-group ">
                           <label>Homepage news Switch</label>  *you selected <?php if ($data->hpage==0){
                                            echo "hide";}  else{echo "show";}?>*   
                           <select class="form-control"  name="hpage">
                        ...
                        <option value="1">show</option>
                           ...
                           <div class="form-group ">
                           <label>break news Switch</label> *you selected <?php if($data->breaknews==0){
                                           echo "hide";} else{echo "show";}?> *     
                           <select class="form-control"  name="breaknews">
                         <option value="0">-- Hide--</option>
                        <option value="1">show</option>
                          </select>
                           </div>
                           ...
                           @endforeach
                              ...
                              <input type= "submit" value="Update News"> <br>  
                              <br>
                           </form>


                           <form method="post" action='/newslogo/{id}'  enctype="multipart/form-data">
                                  @csrf	
						<div class="profile-img">
                        @foreach($news as $data) 
                        @if($data->newslogo)
                <img src="/storage/newslogo/{{$data->newslogo}}" width="100px", height="100px">   
                    @endif   
                           <h5>Upload News image  (COMPULSORY SIZE 770 x 440 Pixels)</h5>
                            <div class="panel-body">
                            <div class="form-group"> 
                       <label>Select Unit's logo (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" value ="{{$data->id}}">
                       @endforeach
                      <input type="file" class="form-control" name="newslogo">
