    ...
    <!--preloader-->
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           ...
                           <button> <a href="{{url('/skoladd/'.$data->id)}}">Back </a>  @endforeach</button>
                        </div>   
                        ...
                        @foreach($skooldeet as $datda)    
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="skolssn" value="{{$datda->skolssn}}" > 
                            </div> 
                            ...
                            <input type="text" class="form-control"  name="skolsacr" value="{{$datda->skolsacr}}">
                            </div>
                        
               

                            <div class="form-group ">
                            <label>School Unit title</label>
                            <input type="text" class="form-control"  name="skolsh" value="{{$datda->skolsh}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="skolsfn" value="{{$datda->skolsfn}}">
                            </div>
                       

                            <div class="form-group ">
                            <label>Location </label>
                            <input type="text" class="form-control" name="supoloc"  value="{{$datda->supoloc}}">
                            </div>
                        
                            <div class="form-group ">
                            <label>Support Email </label>
                            <input type="text" class="form-control" name="supoemal" value="{{$datda->supoemal}}" >
                            </div>


                            <div class="form-group ">
                            <label>Support Phone </label>
                            <input type="integer" class="form-control" name="supofon" value="{{$datda->supofon}}" >
                            </div>
                        

                            <div class="form-group ">
                              <label>About school </label>
                              <textarea class="form-control" id="body" name="abtskol" >{!!$data->abtskol!!}</textarea>
                            </div>


                            <div class="form-group ">
                              <label>History of School</label>
                              <textarea class="form-control" id="body2"name="hiskol" >{!!$data->hiskol!!}</textarea>
                            </div>
                            

                            <div class="form-group ">
                              <label>Deans Profile</label>
                              <textarea class="form-control" id="body3"name="deansprof" >{!!$data->deansprof!!}</textarea>
                            </div>
                            @endforeach
                                 ...
                                 <tbody>                             
                                    ...
                                    <td style="display: none;">{{$datda->id}}</td> 
                                            <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> school image</a><br><br>
                                                        <a class="dropdown-item lumi" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i>history image </a>
                                                      </div>
                                                     </div> 
                                                     </td>     
                                          </div>
                                        ...
                                        <div>
                                          ...
                                          @foreach($skooldeet as $datda)
                                       @endforeach
                                  <a href= "{{url('/viewimage/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View images</a>
                                    </td>
     ...
     <div id="truce" class="modal custom-modal fade" role="dialog">
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                           ...
                           <h5 class="modal-title">Upload School Image</h5>
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/abtimg'  enctype="multipart/form-data">
                                  @csrf	

                                  <div class="col-sm-6 col-md-12">
                                 <div class="form-group"> 
              
                       <label>Select School image (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" id ="id3">
                       <input type="hidden" name="imgnam" value="schimg">
                      <input type="file" class="form-control" name="abtimg">
                     </div>
                     </div>
     ...
     <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @endforeach
                        <h5 class="modal-title">Upload history Image</h5>
                 ...
                 <div class="panel-body">
                  ...
                  <form method="post" action='/histimg'  enctype="multipart/form-data">
                     @csrf	
                     <div class="col-sm-6 col-md-12">
              <div class="form-group"> 

             <label>Select history logo (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
            <input type="hidden" name="id" id ="id4">
            <input type="hidden" name="imgnam" value="hisimg">
             <input type="file" class="form-control" name="hisimg">
              </div>
                 </div>
