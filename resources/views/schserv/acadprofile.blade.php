               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                           ...
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($acad as $data)
                                 <h4> ADD further details  to "{{$data->acadn}}"</h4>
                                 @endforeach
                              </a>
                           </div>
                           <button> <a href="{{url('/acaddet/'.$data->id)}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                        <form method="post"  action='/acadprofprocess/{id}' enctype="multipart/form-data">
                           @csrf	 
                        @foreach($acad as $datda)    
                            <div class="form-group ">
                              <label>Academic  Name</label>
                              <input type="text"  class="form-control" name="acadn" value="{{$datda->acadn}}"> 
                            </div> 
                            ...
                            <input type="text" class="form-control" name ="acadacr" value="{{$datda->acadacr}}">
                            </div>
                        
               

                            <div class="form-group ">
                            <label>Academic  Unit tittle</label>
                            <input type="text" class="form-control"  name ="acadh" value="{{$datda->acadh}}">
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control"  name ="acadfn" value="{{$datda->acadfn}}">
                            </div>
             


                            <div class="form-group ">
                              <label>About Academic Unit </label>
                              <textarea class="form-control" id="body" name="abtacad" >{!!$data->abtacad!!}</textarea>
                            </div>
                       ...
                       <form method="post"  action='/acadstaff'>
                          @csrf	 
                       @foreach($acad as $datda)  
                       <div class="form-group ">  
                          
                           <input type="hidden"  class="form-control" name="acadid" value="{{$datda->id}}" >
                           @endforeach
                           </div>
                        ...
                        @endforeach
                           ...
                           <input type= "submit" value="Update Staff"> <br>  <br>
                                  ...
                                  <a href= "{{url('/viewacadstaff/'.$datda->id)}}" data-target=""><i class="fa fa-pencil m-r-5"></i> View  Unit staff</a>
                                    </td>
                                           </div>
                                           </tr>
                                           <div>
