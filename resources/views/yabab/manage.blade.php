                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Create Management Info</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/createman'>
                           @csrf	
                            <div class="form-group ">
                              <label>Fullname </label>
                              <input type="text"  class="form-control" name="fullnamzx" >
                            </div>
                            <div class="form-group ">
                            <label>position </label>
                              <input type="text"   class="form-control" name="poszx" >
                            </div>
                            
                              <input type= "submit" value="Savemanagement"> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($mgt as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deleteman/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updateman/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label>Fullname </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="fullnamzx3" id="fullnamzx2">
                            </div>
                            <div class="form-group ">
                            <label>position </label>
                              <input type="text"   class="form-control" name="poszx3" id="poszx2" >
                            </div>
                        

                            <input type= "submit" value="Update management"> <br>  <br>
                           </form>
