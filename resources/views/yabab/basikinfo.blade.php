         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Create Basic Info</h1>
                  <small>Create basic details.</small>
               </div>
            </section>
         	<!-- Page Wrapper -->
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatebasikinfo/{id}'>
                           @csrf	

                            <div class="form-group ">
                            @foreach($basikk as $data)
                            <input type="hidden" name="id" class="form-control"  value="{{$data->id}}" >
                              <label>Contact Phone number </label>
                              <input type="text"  class="form-control" name="fonyz" value="{{$data->fonyz}}" >
                            </div>

                            <div class="form-group ">
                            <label>Contact email address </label>
                              <input type="text"   class="form-control" name="emalyz"  value="{{$data->emalyz}}">
                            </div>
                          
                            <div class="form-group ">
                            <label>Rector's Welcome message</label>
                              <textarea class="form-control" name="welcumyz" > {{$data->welcumyz}}</textarea>
                            </div>

                            <div class="form-group ">
                            <label>College's google map embed code</label>
                              <input type="text"   class="form-control" name="mapyz" value="{{$data->mapyz}}">
                            </div>

                            <div class="form-group ">
                            <label>College Postal address</label>
                              <input type="text"  class="form-control" name="posyz"  value="{{$data->posyz}}">
                            </div>

                            <div class="form-group ">
                            <label>Video tour youtube link</label>
                              <input type="text"   class="form-control" name="utubeyz"  value="{{$data->utubeyz}}">
                            </div>
                            @endforeach

                            <div>
                              
                              <input type= "submit" value="SaveBasicInfo"> <br>  <br>
                           </form>  
                                                    </div>
                                                     </div>
