                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Create Quick link Info</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/createqwik'>
                           @csrf	
                            <div class="form-group ">
                              <label>Link Name </label>
                              <input type="text"  class="form-control" name="linqkx" >
                            </div>
                            <div class="form-group ">
                            <label>Link Url </label>
                              <input type="text"   class="form-control" name="linuqkx" >
                            </div>
                             
                            <div class="form-group ">
                            <label>Select Category</label>
                            <select class="form-control"  name="catekx" >
                          <option value="">-- Select --</option>
                           @foreach($paymenttype as $paymenttype)
                       <option value="{{$paymenttype->namkzx}}">{{$paymenttype->namkzx}}</option>
                         </option>
                            @endforeach  
                           </select>
                            </div>
                              ...
                              <input type= "submit" value="SaveQuicklink"> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($qwik as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deleteqwik/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updateqwik/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label>Link Name </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="linqkx3"  id="linqkx2">
                            </div>
                            <div class="form-group ">
                            <label>Link Url </label>
                              <input type="text"   class="form-control" name="linuqkx3" id="linuqkx2">
                            </div>
                        
                            <div class="form-group ">
                            <label>Select Category</label>
                            <select class="form-control"  name="catekx3"  id="catekx2" >
                          <option value="">-- Select --</option>
                          @foreach($payment as $truce)
                         <option value="{{$truce->namkzx}}">{{$truce->namkzx}}</option>
                         @endforeach
                           </select>
                            </div>

                            <input type= "submit" value="Update Quick Link"> <br>  <br>
                           </form>
