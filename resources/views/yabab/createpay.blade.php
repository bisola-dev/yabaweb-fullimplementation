                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/createpaytype'>
                           @csrf	
                            <div class="form-group ">
                              <label> Name </label>
                              <input type="text"  class="form-control" name="namkzx" >
                            </div>
                        
                            
                              <input type= "submit" value="Savepaymenttype"> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($paymenttype as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deletecreatepay/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatecreatepay/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Name </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="namkzx3" id="namkzx2" >
                            </div>
                             <div>
                            <input type= "submit" value="Update payment"> <br>  <br>
                            </div>
                           </form>
