...
<head>
      ...
      <title>Create Scroll text.</title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Create Scroll text</h1>
                  <small>Create Scroll text.</small>
               </div>
            </section>
         	<!-- Page Wrapper -->
       ...
       @if(session()->has('success'))
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4>Add Scrolling Text.</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body">
                          
                           <form method="post" action='/createscrol'>
                           @csrf	
                            <div class="form-group ">
                              <label>Small text</label>
                              <input type="text"  class="form-control" name="smalyz" >
                            </div>
                            <div class="form-group ">
                            <label>Big text </label>
                              <input type="text"   class="form-control" name="bigyz" >
                            </div>
                            
                            <div class="form-group ">
                            <label>Link Button Text</label>
                              <input type="text"   class="form-control" name="linyz" >
                            </div>
                            <div class="form-group ">
                            <label>Link Url</label>
                              <input type="text"  class="form-control" name="lurlyz" >
                            </div>
                          
                              <input type= "submit" value="Submit Scroll Text"> <br>  <br>
                           </form>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    <td>@if($data->scrolimg!="")<img src="/storage/scrolimg/{{($data->scrolimg)}}" width="100px" height="100px">
                                     @elseif($data->scrolimg=="")<img src="/storage/scrolimg/avat.png" width="100px" height="100px">
                                     @endif
                                    </td>
                                       ...
                                       <td class="text-right">
                                              ...
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-5"></i> Upload Scroll image </a>
                                                      </div>
                                                     </div> 
                                                     </td>     

                                        
                                        <td> <form method="GET" action='/deletescrol/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-header">
                                <h5 class="modal-title">Edit Scroll details</h5>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatescrol/{id}'>
                                  @csrf	
                            <div class="form-group ">
                              <label>Small text</label>
                              <input type="text"  class="form-control" name="smalyz3"  id="smalyz2" >
                              <input type="text" name="id" class="form-control"  id="id2">
                            </div>
                            <div class="form-group ">
                            <label>Big text </label>
                              <input type="text"   class="form-control" name="bigyz3" id="bigyz2" >
                            </div>
                            
                            <div class="form-group ">
                            <label>Link Button Text</label>
                              <input type="text"   class="form-control" name="linyz3" id="linyz2">
                            </div>
                            <div class="form-group ">
                            <label>Link Url</label>
                              <input type="text"  class="form-control" name="lurlyz3" id="lurlyz2" >
                            </div>
                          
                              <input type= "submit" value="Update Scroll Text"> <br>  <br>
                              </form>
                           </div>
						        </div>
                           </div>
         ...
         <div class="modal-header">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        <h5 class="modal-title">Upload Scrolling Image</h5>
                ...
                <div class="row">
                  <div class="panel-body">
   <form method="post" action='/scrolimg/{id}'  enctype="multipart/form-data">
          @csrf	
   <div class="col-sm-6 col-md-12">
  <div class="form-group"> 
  <label>Select Scroll image (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
 <input type="hidden" name="id" id ="id3">
 <input type="file" class="form-control" name="scrolimg" id="scrolimg3">
  </div>
