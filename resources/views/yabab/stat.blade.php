                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/statpro'>
                           @csrf	
                            <div class="form-group ">
                              ...
                              <input type= "submit" value="Savestatus"> <br>  <br>
                           </form>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($stat as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deletestat/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatestat/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Name </label>
                             ...
                             <div>
                            <input type= "submit" value="Update status"> <br>  <br>
                            </div>
                           </form>
