                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="fullnzx" >
                            </div>
                            <div class="form-group ">
                              <label>Admin Mail</label>
                              <input type="text"  class="form-control" name="admail" >
                            </div>
                            <div class="form-group ">
                            ...
                            <select class="form-control"  name="categl"  >
                         ...
                         <option value="{{2}}">Admin</option>
                              ...
                              <input type= "submit" value="Save Admin"> <br>  <br>
                           </form>
                           ...
                           <?php $counter=0;?>
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>                             
                                    ...
                                    <tr>
                                    @forelse($sadmin as $data)
                                       <td>{{$counter+=1}}</td>
                                       <td>{{$data->admail}}</td>
                                       <td>@if($data->categl==1){{'superadmin'}}
                                          @elseif($data->categl==2){{'admin'}}
                                       @endif
                                       </td>
                                       <td style="display: none;">{{$data->id}}</td>
                                       <td style>{{$data->fullnzx}}</td>
                                      
                                                     
                                                </td>

                                        
                                        <td> <form method="GET" action='/deleteadmin/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
