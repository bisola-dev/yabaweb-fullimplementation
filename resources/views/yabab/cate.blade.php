                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/createcatetype'>
                           @csrf	
                            <div class="form-group ">
                              <label> Name </label>
                              <input type="text"  class="form-control" name="caten" >
                            </div>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($cate as $data)
                                       ...
                                       <td class="text-right">
                                        ...
                                        <td> <form method="GET" action='/deletecate/{id}'>  
                                        {{method_field('DELETE')}}
                                             @csrf
               ...
               <div id="checck" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post" action='/updatecate/{id}'>
                                  @csrf	
                                  <div class="form-group ">
                              <label> Name </label>
                              <input type="hidden" name="id" class="form-control"  id="id2">
                              <input type="text"  class="form-control" name="caten3" id="caten2" >
                            </div>
                             <div>
                            <input type= "submit" value="Update Category"> <br>  <br>
                            </div>
                           </form>
